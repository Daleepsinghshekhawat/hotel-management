...
const ROLE_TABS = ["all", "admin", "hotelOwner", "user"];
...
const ROLE_BADGES = {
  ...
  superadmin: { bg: "#faf5ff", color: "#6b21a8", label: "Super Admin" },
};

export default function UsersAndAdmins() {
  ...
  const fetchUsers = async () => {
    setLoading(true);
    try {
      // Fetch users from role-based endpoint
    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif" }}>
      <div style={{ marginBottom: "28px" }}>
        ...
        <p style={{ margin: 0, color: "#64748b", fontSize: "14px" }}>
          View and manage all user accounts, administrators, and hotel owners registered on the platform.
        </p>
      </div>
                  ...
                  >
                    ...
                    <td style={{ padding: "16px 20px", textAlign: "center" }}>
                      <button
                        ...
                        disabled={isBusy || user.role === "superadmin"}
                        style={{
                          padding: "6px 12px",
                          borderRadius: "6px",
                          ...
                          opacity: user.role === "superadmin" ? 0.4 : 1,
                          fontSize: "12px",
                          fontWeight: 600,
                          transition: "all 0.2s",
                        }}
