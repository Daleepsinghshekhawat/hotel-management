    ...
    <div style={{ fontFamily: "'Segoe UI', sans-serif", maxWidth: "720px" }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: "grid", gap: "18px" }}>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", padding: "10px", background: "#f8fafc", borderRadius: "8px", border: "1px solid #cbd5e1" }}>
            {availableAmenities.map((amenity) => (
              <label key={amenity} style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", color: "#374151", cursor: "pointer" }}>
                <input
                  type="checkbox"
                  value={amenity}
