...
router.post("/addState", verifySuperAdmin, stateController.createState);
...
router.patch("/updateState/:id", verifySuperAdmin, stateController.updateState);
router.delete("/deleteState/:id", verifySuperAdmin, stateController.deleteState);
...
router.post("/createDistrict", verifySuperAdmin, districtController.createDistrict);
...
router.patch("/updateDistrict/:id", verifySuperAdmin, districtController.updateDistrict);
router.delete("/deleteDistrict/:id", verifySuperAdmin, districtController.deleteDistrict);
...
router.post("/createCity", verifySuperAdmin, cityController.createCity);
...
router.patch("/updateCity/:id", verifySuperAdmin, cityController.updateCity);
router.delete("/deleteCity/:id", verifySuperAdmin, cityController.deleteCity);
...
router.get("/getUsersByRole/:role", verifySuperAdmin, superAdminController.getUsersByRole);
router.get("/getPaginatedUsersByRole/:role", verifySuperAdmin, superAdminController.getPaginatedUsersByRole);
router.delete("/deleteUser/:id", verifySuperAdmin, superAdminController.deleteUser);
router.patch("/updateUserRole/:id", verifySuperAdmin, superAdminController.updateUserRole);
